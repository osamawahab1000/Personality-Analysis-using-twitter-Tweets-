...
class MyWindow:
    def __init__(self, win):
        self.bg1 = ImageTk.PhotoImage(file=resource_path("Resource_Images/SIF.png"))
        canvas = Canvas(win, width=2500, height=2000)
        canvas.pack(expand=True, fill=BOTH)
        canvas.pack(padx=0, pady=170)
        canvas.create_image(785, 70, image=self.bg1, anchor="ne")
        self.D_lbl0 = ttk.Label(win, text='Personality Based Analysis Using Twitter Data', font=("Arial", 30))
        self.D_lbl0.place(x=240, y=30)
        ...
        self.btn1.place(x=603, y=165)

    def mbti(self):
        newwin = Toplevel(window)
        newwin.geometry("1280x820")
    ...
    def mbt(self):
        ...
        newwin1.geometry("1280x820")
        self.D_lbl0 = ttk.Label(newwin1, text='Personality Analysing Using Twitter Data ',
                                font=("Arial", 30))
        self.D_lbl0.place(x=300, y=20)
    ...
    def explore(self):
        ...
        self.D_lbl0 = ttk.Label(newwin2, text='Personality Analysing Using Twitter Data ',
                                font=("Arial", 30))
        self.D_lbl0.place(x=300, y=20)
    ...
    def explore1(self):
        ...
        self.D_lbl0 = ttk.Label(newwin3, text='Personality Analysing Using Twitter Data ',
                                font=("Arial", 30))
        self.D_lbl0.place(x=300, y=20)
    ...
    def explore3(self):
        ...
        self.D_lbl0 = ttk.Label(newwin5, text='Personality Analysing Using Twitter Data ',
                                font=("Arial", 30))
        self.D_lbl0.place(x=300, y=20)
    ...
    def explore4(self):
        ...
        self.D_lbl0 = ttk.Label(newwin6, text='Personality Analysing Using Twitter Data ',
                                font=("Arial", 30))
        self.D_lbl0.place(x=300, y=20)
    ...
    def explore5(self):
        ...
        self.D_lbl0 = ttk.Label(newwin7, text='Personality Analysing Using Twitter Data ',
                                font=("Arial", 30))
        self.D_lbl0.place(x=300, y=20)
    ...
    def explore6(self):
        ...
        self.D_lbl0 = ttk.Label(newwin8, text='Personality Analysing Using Twitter Data ',
                                font=("Arial", 30))
        self.D_lbl0.place(x=300, y=20)
    ...
    def twitter(self):
        ...
        newwin9.geometry("1280x820")
        self.D_lbl0 = ttk.Label(newwin9, text='Personality Analysing Using Twitter Data ',
                                font=("Arial", 30))
        self.D_lbl0.place(x=300, y=20)
    ...
    def posts(self):
        ...
        self.btn1.place(x=365, y=120)
        self.D_lbl0 = ttk.Label(newwin10, text='Personality Analysing Using Twitter Data ',
                                font=("Arial", 30))
        self.D_lbl0.place(x=300, y=20)
    ...
    def recomends(self):
        ...
        self.btn1.place(x=365, y=120)
        self.D_lbl0 = ttk.Label(newwin11, text='Personality Analysing Using Twitter Data ',
                                font=("Arial", 30))
        self.D_lbl0.place(x=300, y=20)
    ...
    def home(self):
        ...
        self.btn1.place(x=365, y=120)
        self.D_lbl0 = ttk.Label(newwin12, text='Personality Analysing Using Twitter Data ',
                                font=("Arial", 30))
        self.D_lbl0.place(x=300, y=20)
    ...
    def home1(self):
        ...
        newwin13.geometry("1280x820")
        self.bg1 = ImageTk.PhotoImage(file=resource_path("Resource_Images/Home.png"))
        canvas = Canvas(newwin13, width=600, height=600)
        canvas.pack(expand=True, fill=BOTH)
        canvas.pack(padx=150, pady=90)
        canvas.create_image(795, 50, image=self.bg1, anchor="ne")
        self.D_lbl0 = ttk.Label(newwin13, text='Personality Analysing Using Twitter Data ',
                                font=("Arial", 30))
        self.D_lbl0.place(x=300, y=20)
        self.btn1 = ttk.Button(newwin13, text='MBTI DATA', style='Accent.TButton',
                               command=lambda: [self.mbti(), newwin13.destroy()])
        self.btn1.place(x=500, y=85)
        self.btn1 = ttk.Button(newwin13, text='TWITTER DATA', style='Accent.TButton',
                               command=lambda: [self.twitter(), newwin13.destroy()])
        self.btn1.place(x=650, y=85)


from tkinter import ttk

window = tk.Tk()
window.tk.call('source', resource_path(resource_path('Resource_Images/forest-light.tcl')))

# Set the theme with the theme_use method
ttk.Style().theme_use('forest-light')

window.title("SOCIAL MEDIA PERSONALITY ANALYSIS")
mywin = MyWindow(window)
window.geometry("1280x820")
window.iconphoto(True, tk.PhotoImage(file=resource_path('Resource_Images/SIF.png')))
window.mainloop()
